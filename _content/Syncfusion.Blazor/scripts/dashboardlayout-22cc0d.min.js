...
/* harmony import */ var _modules_dashboardlayout_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_dashboardlayout_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfdashboardlayout = function sfdashboardlayout(exports) {
  ...
  function (_super) {
    ...
    DashboardLayout.prototype.panelPropertyChange = function (panel, value) {
      this.allowServerDataBinding = false; // eslint-disable-next-line
    ...
    DashboardLayout.prototype.mergePersistPanelData = function (persistedData) {
      ...
      if (!(sf.base.isNullOrUndefined(data) || data === '') || !sf.base.isNullOrUndefined(persistedData)) {
        ...
        for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
          ...
          if (_typeof(sf.base.getValue(key, this)) === 'object' && !sf.base.isNullOrUndefined(sf.base.getValue(key, this))) {
