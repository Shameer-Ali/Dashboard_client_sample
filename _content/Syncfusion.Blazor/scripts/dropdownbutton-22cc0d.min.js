...
var sfdropdownbutton = function sfdropdownbutton(exports) {
  ...
  function (_super) {
    ...
    DropDownButton.prototype.mousedownHandler = function (e) {
      ...
      if (this.dropDown && !this.canOpen() && !(sf.base.closest(trgt, '[id="' + this.getPopUpElement().id + '"]') || sf.base.closest(trgt, '[id="' + this.element.id + '"]'))) {
        this.closePopup(e);
      }
    };
    ...
    __decorate([sf.base.Property(false)], DropDownButton.prototype, "createPopupOnClick", void 0);
