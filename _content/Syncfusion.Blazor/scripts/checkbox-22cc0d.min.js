...
var sfcheckbox = function sfcheckbox(exports) {
  ...
  function (_super) {
    ...
    CheckBox.prototype.unWireEvents = function () {
      ...
      sf.base.EventHandler.remove(label, 'mousedown', this.labelMouseDownHandler);
      sf.base.EventHandler.remove(label, 'mouseup', this.labelMouseUpHandler);
    ...
    CheckBox.prototype.wireEvents = function () {
      ...
      var label = wrapper.getElementsByTagName('label')[0];
      sf.base.EventHandler.add(label, 'mousedown', this.labelMouseDownHandler, this);
      sf.base.EventHandler.add(label, 'mouseup', this.labelMouseUpHandler, this);
