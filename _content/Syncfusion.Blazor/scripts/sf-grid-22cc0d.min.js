  ...
  function () {
    ...
    VirtualContentRenderer.prototype.onDataReady = function () {
      ...
      if (this.parent.options.enableVirtualMaskRow) {
        ...
        if (yValue_1 == 0) yValue_1 = yValue_1 - this.parent.options.pageSize * (this.parent.options.rowHeight ? this.parent.options.rowHeight : 35);else if (this.startIndex) yValue_1 = yValue_1 - this.parent.options.pageSize * (this.parent.options.rowHeight ? this.parent.options.rowHeight : 35) - 10;else yValue_1 = this.startIndex ? yValue_1 : 0 - this.parent.options.pageSize * (this.parent.options.rowHeight ? this.parent.options.rowHeight : 35);
        setTimeout(function () {
  ...
  function () {
    ...
    */
    ...
    SfGrid.prototype.gridKeyDownHandler = function (e) {
      ...
      if ((e.key == "Tab" || e.key == 'Escape' || e.key == "shiftTab" || e.key == "Enter" || e.key == "shiftEnter") && (e.target.tagName == 'INPUT' || e.target.classList.contains('e-datepicker') || e.target.classList.contains('e-datetimepicker'))) {
        e.target.blur();
      }
