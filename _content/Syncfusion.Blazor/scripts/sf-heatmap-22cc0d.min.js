...
window.sfBlazor.HeatMap = function () {
  ...
  function () {
    ...
    SfHeatMap.prototype.resizeBound = function () {
      if (this.element) {
        this.dotnetRef.invokeMethodAsync('resizeBound', this.getElementBounds(this.element).height, this.getElementBounds(this.element).width);
      }
    };
    ...
    SfHeatMap.prototype.renderTooltip = function (element, elementId, tooltipOptions, args, cellHighlighting, isCellSelected, textStyle, border) {
  ...
  var HeatMap = {
    ...
    tooltipModule, tooltipOptions, args, cellHighlighting, isCellSelected, textStyle, border) {
      if (element && element.blazorInstance) {
        element.blazorInstance.renderTooltip(element, elementId, tooltipOptions, args, cellHighlighting, isCellSelected, textStyle, border);
      }
    },
