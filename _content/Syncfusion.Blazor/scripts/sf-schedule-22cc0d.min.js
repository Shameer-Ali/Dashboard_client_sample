...
window.sfBlazor.Schedule = function () {
  ...
  function (_super) {
    ...
    DragAndDrop.prototype.dragStop = function (e) {
      ...
      this.parent.dotNetRef.invokeMethodAsync('OnDragStop', startTime, endTime, eventGuid, groupIndex, isSameResource, this.actionObj.isAllDay, indexCol, this.updatedData);
      this.updatedData = [];
      this.multiData = [];
  ...
  function () {
    ...
    SfSchedule.prototype.print = function () {
      ...
      var getScrollableElement = function getScrollableElement(scrollElement) {
  ...
  var Schedule = {
    ...
    createQuickPopup: function createQuickPopup(element, guid, isServerBinding) {
      if (element && element.blazor__instance) {
