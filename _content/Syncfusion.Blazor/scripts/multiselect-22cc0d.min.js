...
/* harmony import */ var _modules_multiselect_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_multiselect_js__WEBPACK_IMPORTED_MODULE_0__);
...
var sfmultiselect = function sfmultiselect(exports) {
  ...
  function createFloatLabel(overAllWrapper, searchWrapper, element, inputElement, value, floatLabelType, placeholder) {
    var floatLinelement = sf.base.createElement('span', {
      className: FLOATLINE
    });
    var floatLabelElement = sf.base.createElement('label', {
      className: FLOATTEXT
    });
  ...
  function (_super) {
        ...
        this.trigger('removing', eventArgs, function (eventArgs) {
          if (eventArgs.cancel) {
            ...
            if (element_1 !== null) {
              ...
              if (_this.value && _this.value.length !== _this.mainData.length && _this.mode === 'CheckBox' && _this.showSelectAll && !(_this.isSelectAll || isClearAll)) {
    ...
    MultiSelect.prototype.multiCompiler = function (multiselectTemplate) {
      ...
      if (multiselectTemplate) {
        try {
          checkTemplate = sf.base.selectAll(multiselectTemplate, document).length ? true : false;
        } catch (exception) {
          checkTemplate = false;
        }
      }
    ...
    MultiSelect.prototype.renderPopup = function () {
      ...
      if (!this.popupObj) {
        ...
        sf.base.append([this.list], this.popupWrapper);
        ...
        if (this.mode === 'CheckBox') {
          ...
          sf.base.addClass([this.popupWrapper], 'e-checkbox');
        }

        if (this.popupHeight !== 'auto') {
          this.list.style.maxHeight = sf.base.formatUnit(overAllHeight);
          this.popupWrapper.style.maxHeight = sf.base.formatUnit(this.popupHeight);
        } else {
          this.list.style.maxHeight = sf.base.formatUnit(this.popupHeight);
        }
    ...
    MultiSelect.prototype.search = function (e) {
      ...
      if (this.checkTextLength() && !this.allowFiltering && !sf.base.isNullOrUndefined(e) && e.keyCode !== 8) {
        ...
        if (this.allowFiltering) {
          ...
          var liCollections = this.list.querySelectorAll('li.' + sf.dropdowns.dropDownBaseClasses.li + ':not(.e-hide-listitem)');
    ...
    MultiSelect.prototype.onDocumentClick = function (e) {
      if (this.mode !== 'CheckBox') {
        ...
        if (!(!sf.base.isNullOrUndefined(this.popupObj) && sf.base.closest(target, '[id="' + this.popupObj.element.id + '"]')) && !this.overAllWrapper.contains(e.target)) {
          this.scrollFocusStatus = false;
        } else {
    ...
    MultiSelect.prototype.updateDelimView = function () {
      ...
      if (this.value && this.value.length) {
        ...
        var totalCompiledString = sf.base.compile(l10n.getConstant('totalCountTemplate')); // eslint-disable-next-line
    ...
    MultiSelect.prototype.updateRemainTemplate = function (raminElement, viewWrapper, remaining, compiledString, totalCompiledString, totalWidth) {
      ...
      raminElement.innerHTML = ''; // eslint-disable-next-line

      var remainTemp = compiledString({
        'count': remaining
      }, this, 'overflowCountTemplate', null, !this.isStringTemplate, null, raminElement); // eslint-disable-next-line
    ...
    MultiSelect.prototype.textboxValueUpdate = function (event) {
      var isRemoveAll = event && event.target && (sf.base.closest(event.target, '.e-selectall-parent') || sf.base.closest(event.target, '.e-close-hooker'));
    ...
    MultiSelect.prototype.showPopup = function () {
      ...
      this.trigger('beforeOpen', args, function (args) {
        if (!args.cancel) {
          if (sf.base.isBlazor() && _this.isServerRendered && _this.itemTemplate) {
          ...
          var liLength = _this.ulElement.querySelectorAll('li.' + sf.dropdowns.dropDownBaseClasses.li + '.' + HIDE_LIST).length;
  ...
  function () {
    ...
    CheckBoxSelection.prototype.setSelectAll = function () {
      if (this.parent.showSelectAll) {
        ...
        if (this.parent.list.classList.contains('e-nodata') || this.parent.listData && this.parent.listData.length <= 1 && !(this.parent.isDynamicDataChange && sf.base.isBlazor()) || this.parent.isDynamicDataChange && !sf.base.isNullOrUndefined(this.parent.value) && this.parent.value.length <= 1 && sf.base.isBlazor()) {
    ...
    CheckBoxSelection.prototype.listSelection = function (args) {
      ...
      if (!sf.base.isNullOrUndefined(this.checkWrapper)) {
        ...
        this.validateCheckNode(this.checkWrapper, checkElement.classList.contains(CHECK), args.li, args.e, selectAll$$1);
      }
    };
    ...
    CheckBoxSelection.prototype.clickHandler = function (e) {
      ...
      if (!sf.base.isNullOrUndefined(this.checkWrapper)) {
        var checkElement = sf.base.select('.' + CHECKBOXFRAME, this.checkWrapper);
        this.validateCheckNode(this.checkWrapper, checkElement.classList.contains(CHECK), null, e, selectAll$$1);
      }
    ...
    CheckBoxSelection.prototype.setDeviceSearchBox = function () {
      ...
      this.parent.popupObj.element.classList.add(mobileFilter); // eslint-disable-next-line @typescript-eslint/naming-convention
    ...
    CheckBoxSelection.prototype.onDocumentClick = function (e) {
      if (this.parent.getLocaleName() !== 'listbox') {
        ...
        if (!(!sf.base.isNullOrUndefined(this.parent.popupObj) && sf.base.closest(target, '[id="' + this.parent.popupObj.element.id + '"]')) && !this.parent.overAllWrapper.contains(e.target)) {
